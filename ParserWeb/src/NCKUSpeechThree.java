...
public class NCKUSpeechThree extends WebPage
{	
	@Override
	void parsingData() throws IOException
	{
		...
		try
		{				
			Document doc = Jsoup.connect("http://apps.acad.ncku.edu.tw/lecture/main/show_list_goto.php?deptno=&page=3").get();
		...
		{
			System.out.println("Connect NCKU Speech Three Error");
		}
