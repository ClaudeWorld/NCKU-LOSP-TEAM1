...
public class NCKUSpeech extends WebPage
{	
	@Override
	void parsingData() throws IOException
	{
		String cmpGet = "show_list_goto.php?deptno=";
		String cmpBreak = "show_list_goto.php?deptno=&page=2";
		...
		try
		{				
			Document doc = Jsoup.connect("http://apps.acad.ncku.edu.tw/lecture/main/show_list_goto.php?deptno=&page=1").get();
		...
		{
			System.out.println("Connect NCKU Speech One Error");
		}
